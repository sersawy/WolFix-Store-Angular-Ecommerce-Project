...
export class ProductImageSlider implements OnInit {
  ...
  ngOnInit(): void {
    // this.images = [
    //   {
    //     itemImageSrc: 'https://api.sersawy.com/products/imgs/products/1/1.webp',
    //     thumbnailImageSrc: 'https://api.sersawy.com/products/imgs/products/1/1.webp',
